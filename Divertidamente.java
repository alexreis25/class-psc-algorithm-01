...
public class Divertidamente {
    public static void main(String[]args){
        ...
        String fezAmizade ;
        int qtdAmizades , tristeza = 0 , alegria=0,alegria2=0,tristeza2=0;
        ...
        int alegria3 = exercicios * 10;
        int tristeza3=faltamExercicios*10;

        int alegriaTotal = alegria + alegria2 + alegria3 ; 
        int tristezaTotal = tristeza + tristeza2 + tristeza3;

        if(alegriaTotal>tristezaTotal){
